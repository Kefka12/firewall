...
def set_check_ports(p4info_helper, ingress_sw, egress_sw,ingress_port,egress_spec,dir):
...
def set_ipv4_lpmt(p4info_helper, ingress_sw, egress_sw,
...
def main(p4info_file_path, bmv2_file_path):
    ...
    try:
        ...
        # s1 流规则下发
        set_check_ports(p4info_helper, s1, s1,1,3,0)
        set_check_ports(p4info_helper, s1, s1,1,4,0)
        set_check_ports(p4info_helper, s1, s1,2,3,0)
        set_check_ports(p4info_helper, s1, s1,2,4,0)
        set_check_ports(p4info_helper, s1, s1,3,1,0)
        set_check_ports(p4info_helper, s1, s1,3,2,0)
        set_check_ports(p4info_helper, s1, s1,4,1,0)
        set_check_ports(p4info_helper, s1, s1,4,2,0)
        set_ipv4_lpmt(p4info_helper, s1, s1, 
        ...
        # s2 流规则下发
        set_ipv4_lpmt(p4info_helper, s2, s2, 
        ...
        # s3 流规则下发
        set_ipv4_lpmt(p4info_helper, s3, s3, 
        ...
        # s4 流规则下发
        set_ipv4_lpmt(p4info_helper, s4, s4, 
